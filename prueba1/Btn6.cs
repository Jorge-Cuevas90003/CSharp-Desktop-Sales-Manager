...
namespace prueba1
{
    public partial class Btn6 : Form
    {
        ...
        public DataSet reportar()
        {
            try
            {
                ...
                string Instrucciones1 = "select *From productos_ventas;";
        ...
        private void Btn6_Load(object sender, EventArgs e)
        {
            DataSet dst = new DataSet();
            dst = reportar();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sqlFormattedDate = dateTimePicker1.Value.ToString("yyyy-MM-dd");
            MessageBox.Show("" + sqlFormattedDate);
            RegistroProd nw = new RegistroProd();
